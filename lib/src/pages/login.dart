  ...
  /*                 Row(
    ...
    Widget _armarTitulo() {
      ...
      return ClipRRect(
        ...
        Widget _iniciarSesionApple(BuildContext context) {        
      ...
      return ClipRRect(
        clipBehavior: Clip.hardEdge,
          ...
          child: Consumer<LoginState>(
              ...
              onPressed: () {
                if(checkboxValue == true){
                Provider.of<LoginState>(context).login(LoginProvider.apple);
                }},
              ...
              child: Row(
                ...
                // SizedBox(width: 53.0),
                  ClipRRect(
                      ...
                      color: Colors.transparent,
                      //padding: EdgeInsets.all(10.0),
                      child:  Image.asset('assets/logos/logo Apple.png',
                              fit: BoxFit.scaleDown,
                              scale: 20.0,),
                    ),
                  ),
                  SizedBox(width: 30.0,),
                  Text('Iniciar con Apple',style: GoogleFonts.rubik(textStyle:TextStyle(color:Colors.white,
                          fontSize: 14.0, fontWeight: FontWeight.w600, letterSpacing: 0.15
                          ))),
                  SizedBox(width: 30.0,)
                ],
