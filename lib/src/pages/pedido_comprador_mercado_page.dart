...
class PedidosCompradorMercadoPage extends StatefulWidget {
  @override
  _PedidosCompradorMercadoPageState createState() => _PedidosCompradorMercadoPageState();
}

class _PedidosCompradorMercadoPageState extends State<PedidosCompradorMercadoPage> {
...
/*             if (productoValidacion == true) {
          ...
          return ListadoProductosMercado(
            pedidos: data,
            yaPaso: yaPaso,
