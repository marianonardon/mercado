...
class _ListadoPedidosDetalleMercadoState extends State<ListadoPedidosDetalleMercado> {
  ...
  // height: double.infinity,
    ...
    child: Column(
      children: <Widget>[
        ...
        SizedBox(height:10.0),
        botonValorar(pedido.estadoID, pedido.pedidoID,pedido.pedidoComercioID,pedido.pedidoFecha,mercado,pedido.comercioID),
  ...
  botonValorar(estadoId,pedidoId,pedidoComercioId2,pedidoFecha,mercadoId,comercioId){
    MediaQueryData media = MediaQuery.of(context);
    final PedidoArguments args = ModalRoute.of(context).settings.arguments;
    DateTime fechaDePedido = DateTime.parse(pedidoFecha);
    DateTime fechaSumada = fechaDePedido.add(Duration(hours: 1));
      ...
      return GestureDetector(
            onTap: () async {
              ...
              showDialog(
                ...
                await PedidoActualizar().updatePedido('5',pedidoId,pedidoComercioId2,context);
                Navigator.pushNamed(context, 'valoracionPuesto', arguments: ValoracionArguments(mercadoId ,comercioId));
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  //width: media.size.width * 0.95,
                  child: Center(
                    child: Text('Valorar puesto',style: GoogleFonts.rubik(textStyle:TextStyle(color:Colors.black,
                    fontSize: 16.0, fontWeight: FontWeight.w600,
                    ))),
                  )
